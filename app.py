...
def download_file(user_id, filename):
    print(f"Download requested for: user_id={user_id}, filename={filename}")
    try:
        return send_from_directory(os.path.join(uploads_dir, user_id), filename, as_attachment=True)
